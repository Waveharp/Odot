...
describe "Creating todo lists" do 
	...
	it "displays an error when todo list has a title with less than 3 characters" do
		expect(TodoList.count).to eq(0)
	...
	it "displays an error when todo list has a description with less than 5 characters" do
		expect(TodoList.count).to eq(0)
